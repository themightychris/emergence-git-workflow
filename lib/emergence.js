...
Site.prototype.getBaseUrl = function login() {
    return (this.options.useSSL ? 'https' : 'http') + '://' + this.options.hostname;
};
...
Site.prototype.promptLogin = function(callback) {
    var site = this;
    ...
    inquirer.prompt([
        ...
        site.login(answers.username, answers.password, callback);
    });
}